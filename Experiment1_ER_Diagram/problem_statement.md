...
### ER Diagram:
<img width="1111" height="859" alt="image" src="https://github.com/user-attachments/assets/98fb48a5-80bb-4eb4-bab8-ba30e6881e85" />
...
|Attendanc|attendance_id (PK), status, session_id (FK), trainer_id (FK)                           |	Tracks attendance of members in specific sessions.                             |
...
### ER Diagram:
<img width="1123" height="804" alt="image" src="https://github.com/user-attachments/assets/766af530-9f5e-4d7d-a63e-ab0fc95db2e1" />
...
### ER Diagram:
<img width="809" height="694" alt="image" src="https://github.com/user-attachments/assets/6082883a-b744-4e77-a0e0-6e693f8d5f44" />
...
|have	        |M:1        |	Reservation (Total), Restaurant (Partial|	Each reservation is made at exactly one restaurant, while a restaurant can have many reservation|
|associated_wi|	1:1       |Both Total                               |	Each order is associated with exactly one delivery record, and each delivery belongs to one orde|
